	  ...
	  <div className="flex-1 flex flex-col">
	    <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
	      <div className="flex items-center space-x-3">
	        ...
	        >
	          <i className="ri-menu-line w-5 h-5 flex items-center justify-center text-gray-600" />
	        </button>
	        <button
	          onClick={handleGoBack}
	          className="p-2 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer"
	        >
	          <i className="ri-arrow-left-line w-5 h-5 flex items-center justify-center text-gray-600" />
	        </button>
	      ...
	      <div className="flex items-center justify-between text-sm text-gray-600 relative">
	        <div className="flex items-center space-x-2 cursor-pointer">
	          ...
	          <i className="ri-arrow-down-s-line w-4 h-4 flex items-center justify-center text-gray-400" />
	        </div>
	      </div>
	    </div>

	    {/* 여기서부터 내용 교체 (원래 카드 스타일 유지, 내부 내용은 사진처럼 우측 작은 input 포함) */}
	    <div className="flex-1 overflow-y-auto p-6">
	      <div className="bg-white rounded-xl border border-gray-200 min-h-full">
	        <div className="p-8">
	          <div className="max-w-5xl mx-auto w-full">
	            <h1 className="text-3xl font-bold text-[#0f3b6b] mb-6">접근권한 설정</h1>

	            {/* --- 현재 경로 정보 섹션 */}
	            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
	              <h4 className="text-lg font-semibold text-gray-900 mb-4">현재 경로 정보</h4>
	              ...
	              <div className="grid grid-cols-12 gap-4 items-start">
	                ...
	                <div className="col-span-12 md:col-span-9">
	                  <label className="block text-sm font-medium text-gray-700 mb-2">현재 경로</label>
	                  <input
	                    type="text"
	                    ...
	                    placeholder="D:/InnoBot_v3/docs"
	                  />
	                  <label className="block text-sm font-medium text-gray-700 mt-4 mb-2">상위 경로</label>
	                  <input
	                    type="text"
	                    className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
	                    placeholder="상위 경로"
	                ...
	                <div className="col-span-12 md:col-span-3">
	                  <label className="block text-sm font-medium text-gray-700 mb-2">계층</label>
	                  <input
	                    type="number"
	                    placeholder="0"
	                    className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
	            ...
	            <div className="bg-white rounded-lg border border-gray-200 p-6">
	              <h4 className="text-lg font-semibold text-gray-900 mb-4">접근권한 설정</h4>
